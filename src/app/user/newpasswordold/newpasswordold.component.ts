...
@Component({
  selector: 'app-newpasswordold',
  templateUrl: './newpasswordold.component.html',
  styleUrls: ['./newpasswordold.component.scss']
})
export class NewpasswordoldComponent implements OnInit {
