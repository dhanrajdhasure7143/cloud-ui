...
@Component({
  selector: 'app-changepasswordold',
  templateUrl: './changepasswordold.component.html',
  styleUrls: ['./changepasswordold.component.scss']
})
export class ChangepasswordoldComponent implements OnInit {
